...
public class PicModel {
    ...
    public void insertPic(byte[] b, String type, String name, String user) {
        try {
            ...
            Boolean success = (new File("/var/tmp/instafrank/")).mkdirs();
            FileOutputStream output = new FileOutputStream(new File("/var/tmp/instafrank/" + picid));
    ...
    public byte[] picresize(String picid,String type) {
        try {
            BufferedImage BI = ImageIO.read(new File("/var/tmp/instafrank/" + picid));
       ...
       // LinkedList<Pic> Pics = new LinkedList<>();
        ...
        if (rs.isExhausted()) {
            ...
            for (Row row : rs) {
                Pic pic = new Pic();
                pic.setOwner(User);
                pic.setDate(row.getDate("pic_added"));
